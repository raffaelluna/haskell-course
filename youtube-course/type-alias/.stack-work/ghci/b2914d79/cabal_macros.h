...
/* package type-alias-0.1.0.0 */
#ifndef VERSION_type_alias
#define VERSION_type_alias "0.1.0.0"
#endif /* VERSION_type_alias */
#ifndef MIN_VERSION_type_alias
#define MIN_VERSION_type_alias(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_type_alias */
...
#define CURRENT_COMPONENT_ID "type-alias-0.1.0.0-8S9wA6w9asvstIcIujBDB-type-alias"
