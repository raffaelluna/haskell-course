...
/* package algebric-data-types-0.1.0.0 */
#ifndef VERSION_algebric_data_types
#define VERSION_algebric_data_types "0.1.0.0"
#endif /* VERSION_algebric_data_types */
#ifndef MIN_VERSION_algebric_data_types
#define MIN_VERSION_algebric_data_types(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_algebric_data_types */
...
#define CURRENT_COMPONENT_ID "algebric-data-types-0.1.0.0-HCKiJc4ExNG8JA1dF1voDr-algebric-data-types"
